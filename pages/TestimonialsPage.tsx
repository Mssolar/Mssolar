                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-8 items-start">
                        {testimonials.map((testimonial, index) => (
                            <div key={index} className={`bg-surface p-8 rounded-lg shadow-lg transform transition-transform duration-300 hover:-translate-y-1 ${index % 2 !== 0 ? 'md:translate-y-8' : ''}`}>
